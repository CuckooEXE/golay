...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pygolay(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_pygolay(void) { return NULL; }
#  else
     initpygolay(void) { }
#  endif
#  endif
...
PyInit_pygolay(void)
{
  return _cffi_init("pygolay", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpygolay(void)
{
  _cffi_init("pygolay", 0x2601, &_cffi_type_context);
}
#endif
